...
residuals_HW_train <- as.vector(Avg_ExtentTS[which(time(Avg_ExtentTS_Train)>=1989)]) - hw_additive_train$fitted[,1]
...
acf(diff12.Extent, lag.max=72)
pacf(diff12.Extent, lag.max=72)
plot(diff12.Extent)
```
